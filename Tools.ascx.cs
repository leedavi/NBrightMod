        ...
        protected override void OnLoad(EventArgs e)
        {
            try
            {
                ...
                if (Page.IsPostBack == false)
                {
                    ...
                    var strOut = LocalUtils.RazorTemplRender("config.tools.cshtml", ModuleId.ToString(""), "configtools" + Utils.GetCurrentCulture(), new NBrightInfo(), Utils.GetCurrentCulture());
                    var lit = new Literal();
                    lit.Text = strOut;
